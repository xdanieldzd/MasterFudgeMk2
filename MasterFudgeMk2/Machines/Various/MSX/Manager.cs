...
namespace MasterFudgeMk2.Machines.Various.MSX
{
    ...
    class Manager : BaseMachine
    {
        ...
        public Manager()
        {
            ...
            if (configuration.FloppyDrive == FloppyDriveTypes.CommonMMIO && File.Exists(configuration.FloppyRomPath))
                cartridgeB = MediaLoader.LoadMedia(this, new FileInfo(configuration.FloppyRomPath));
        }
